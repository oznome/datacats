...
docker rmi -f datacats/postgres-base:9.3 || true
docker build -t datacats/postgres-base:9.3 -f postgres/Dockerfile-postgres postgres/ 
...
docker pull redis 
docker tag redis library/redis
